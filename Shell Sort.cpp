...
{
    cout << "==========================================" << endl;
    cout << "=     PELAJARAN ALGORITMA SHELL SORT     =" << endl;
    cout << "=                UKY 1E8                 =" << endl;
    cout << "==========================================" << endl;
    cout << endl;
    ...
    if (r > 20)
    {
        cout << "elemen tidak boleh melebihi 20" << endl;
        exit(0);
    }
    ...
    { // 1. looping luar untuk menentukan jarak gap, dimulai dari n/2 lalu dibagi 2 disetiap langkahnya hingga gap = 0
        ...
        { // 2. looping untuk menyisir elemen array dimulai dari indeks gap (i) hingga akhir array (n 1)
            ...
            { // 3. looping dalam untuk membandingkan elemen yang berjarak sejauh gap (i) ke arah kiri
                ...
                {
                    // 5. jika elemen kanan lebih kecil, maka lakukan pertukaran posisi (swap)
        ...
        outputdata(arr, n);                                   // memanggil prosedur tampil-arr/array untuk mendisplay hasil susunan angka pada gap ke-i
    }
}
